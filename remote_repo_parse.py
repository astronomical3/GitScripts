...
remote_repo_string = sys.argv[1].replace("https://github.com/", "").replace("https://gitlab.com/", "").replace("https://bitbucket.org/", "").replace("/src/main", "").replace(".git", "").replace("git@bitbucket.org:", "")
